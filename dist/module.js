import {AnalyticsBrowser as $bdjGp$AnalyticsBrowser} from "@segment/analytics-next";


const $f9fadc54e6246fd9$var$traitKey = "ajs_user_traits";
const $f9fadc54e6246fd9$export$4a5f2003196ec3c7 = (name)=>{
    return name.split("_").map((word)=>word.charAt(0).toUpperCase() + word.slice(1)).join(" ");
};
const $f9fadc54e6246fd9$export$28936c37d922dc4c = (products)=>products.map((product)=>({
...
const $f9fadc54e6246fd9$var$formatProductData2 = (product)=>({
...
const $f9fadc54e6246fd9$export$68561b76b3e86457 = (checkout)=>{
    ...
    return {
        ...
        products: $f9fadc54e6246fd9$export$28936c37d922dc4c(lineItems)
    };
};
const $f9fadc54e6246fd9$export$34e327c98e0c303 = async ()=>{
    const customer = JSON.parse(await browser.localStorage.getItem($f9fadc54e6246fd9$var$traitKey));
    return {
...
const $747425b437e121da$var$segment = window.segment = (0, $bdjGp$AnalyticsBrowser).load({
    writeKey: "bevOsoWqV9duPDtFxcCpLG7DJQbKdbLM"
});
console.log($747425b437e121da$var$segment);
function $747425b437e121da$var$initialize() {
    const analytics = window.analytics;
    const browser = window.browser;
    analytics.subscribe("checkout_started", (event)=>{
        $747425b437e121da$var$segment.track((0, $f9fadc54e6246fd9$export$4a5f2003196ec3c7)(event.name), (0, $f9fadc54e6246fd9$export$68561b76b3e86457)(event.data.checkout));
    });
    analytics.subscribe("checkout_completed", (event)=>{
        const eventData = {
            ...
            products: (0, $f9fadc54e6246fd9$export$28936c37d922dc4c)(event.data.checkout.lineItems),
        ...
        $747425b437e121da$var$segment.track((0, $f9fadc54e6246fd9$export$4a5f2003196ec3c7)(event.name), eventData);
    });
    analytics.subscribe("page_viewed", async (event)=>{
        ...
        const eventData = {
            ...await (0, $f9fadc54e6246fd9$export$34e327c98e0c303)(),
            ...pageData
        };
        $747425b437e121da$var$segment.page((0, $f9fadc54e6246fd9$export$4a5f2003196ec3c7)(event.name), eventData);
    });
}
if (document.readyState === "loading") // If document is still loading
document.addEventListener("DOMContentLoaded", $747425b437e121da$var$initialize); // Wait for it to finish loading before running initialize
else // Otherwise, if document has already loaded
$747425b437e121da$var$initialize(); // Run initialize immediately
